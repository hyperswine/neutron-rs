...
__vector_\handler:
	...
	// Add the exception link register, saved program status and exception regs
	mrs	x1,  ELR_EL1
	mrs	x2,  SPSR_EL1
	mrs	x3,  ESR_EL1
	...
	// After returning from exception handling code, replay the saved context
...
// Basically ALIGN(2048) like in the linker script
.align 11

__exception_vector_start:

// Safety: ensure that `CALL_WITH_CONTEXT` = 0x80 bytes.
.org 0x000
...
// Current exception level with SP_ELx > 0
.org 0x200
...
// Lower exception level for AArch64
.org 0x400
...
// Lower exception level for AArch32
.org 0x600
